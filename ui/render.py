# ui/render.py
# LaunchCast NFL — Kasper-Style UI (Option 1)
...
def get_matchup_grade(prob, position):
    """
    V1 Grading: Since defensive stats are neutral for now, 
    we grade based on the projection probability tier.
    """
...
def render_prop_leaderboard(projections_df, prop_type='td'):
    """Renders the Kasper-style scannable table."""
